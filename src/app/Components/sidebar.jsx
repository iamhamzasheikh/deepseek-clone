  ...
  return (
    ...
    >
      ...
      <div className={`border border-transparent flex flex-col items-center ${expand ? 'gap-2' : 'gap-4 py-4'}`}>
        ...
        {/* Profile Icon */}
        <div className={`border border-transparent w-full flex items-center ${expand ? 'hover:bg-white/10 rounded-lg ' : 'w-10 h-10 justify-center'} gap-3 text-white/60 text-sm p-2 cursor-pointer `}>
