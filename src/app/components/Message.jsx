    ...
    return (
        <div className='flex flex-col items-center w-full max-w-3xl text-sm'>
            <div className={`flex flex-col w-full mb-8 ${role == 'user' && 'item-end'}`}>
                ...
                <div className={`group relative flex max-w-2xl py-3 rounded-xl ${role === 'user' ? 'bg-[#414158] px-5' : 'gap-33'}`}>
...

                            {
                                role === 'user' ? (<>
                                    ...
                                    : (<>
                                        ...
                                        <Image className='w-4.5 cursor-pointer' src={assets.regenerate_icon} alt='' />
                                        <Image className='w-4.5 cursor-pointer' src={assets.like_icon} alt='' />
                                        <Image className='w-4.5 cursor-pointer' src={assets.dislike_icon} alt='' />
